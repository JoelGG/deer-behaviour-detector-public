        ...
        with open(self.annotations, "r") as f:
            ...
            for row in reader:
                ...
                for i in indices:
                    ...
                    frames["rgb"].append(frame_transform(self.__crop(frame, bboxs[i])))
                    frames["rgb_cropped"].append(frame_transform(frame))

                    frames["flow"].append(flow_transform(self.__crop(flow_t, bboxs[i])))
                    frames["flow_cropped"].append(flow_transform(flow_t))
